...
for i, label in enumerate (["bed", "fall", "pickup", "run", "sitdown", "standup", "walk"]):
	filepath1 = "/home/..." + str(label) + "*.csv"
	filepath2 = "/home/..." + str(label) + "*.csv"
	outputfilename1 = "/home/..." + str(window_size) + "_" + str(threshold) + "_" + label + ".csv"
	outputfilename2 = "/home/..." + str(window_size) + "_" + str(threshold) + "_" + label + ".csv"
